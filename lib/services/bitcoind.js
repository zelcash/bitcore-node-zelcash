      ...
      return async.waterfall([
        function (callback) {
          ...
          return client.getRawTransaction(txid, 1, function(err, response) {
              ...
              // returns vsize for segwit-positive coins, size is not in zelcash
              ...
              if (tx.version == 5) {
                ...
                tx.collateralOutputHash = result.hex.slice(10, 74);
                var collateralOutputIndexHex = result.hex.slice(74, 82);
                tx.collateralOutputIndex = parseInt(collateralOutputIndexHex, 16);
