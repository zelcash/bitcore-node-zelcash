...
var BASE_PACKAGE = {
  ...
  repository: 'https://github.com/zelcash/bitcore-node-zelcash',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-zelcash': 'zelcash/bitcore-lib-zelcash',
    'bitcore-node-zelcash': 'zelcash/bitcore-node-zelcash'
  }
};
